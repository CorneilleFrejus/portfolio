            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <a href="/" className="flex items-center mb-4 sm:mb-0">
                        <svg xmlns="http://www.w3.org/2000/svg" className='pt-3 -mr-4' width="95px" height="95px" viewBox="0 0 300.000000 300.000000" preserveAspectRatio="xMidYMid meet">  <g transform="translate(0.000000,300.000000) scale(0.100000,-0.100000)" fill="#3F51B5" stroke="none">
                        ...
                        <span className="self-center text-2xl font-semibold text-white">Corneille</span>
                    </a>
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/corneille-kouassivi/" className="mr-4 hover:underline md:mr-6">LinkedIn</a>
                        </li>
                        <li>
                            <a href="https://github.com/CorneilleFrejus" className="mr-4 hover:underline md:mr-6 ">GitHub</a>
                        </li>
                        <li>
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© {currentYear} <a href="/" className="hover:underline">Corneille</a>. All Rights Reserved.</span>
            </div>
        </footer>
    )
}
